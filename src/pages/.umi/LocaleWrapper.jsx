...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/桌面/大学报告、论文、实验/HIT-ICES/platform/Front/src/locales/en-US.js')),
    },
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('D:/桌面/大学报告、论文、实验/HIT-ICES/platform/Front/src/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
